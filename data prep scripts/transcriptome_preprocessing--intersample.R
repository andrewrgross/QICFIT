...
trans.df <- addMedSD(trans.df)                # Make new DF with median & sd
...
write.csv(row.names(med.v.sd.supertight),'Z:/Data/Andrew/QICFIT/housekeeping.ids_3559.csv', row.names = FALSE)
