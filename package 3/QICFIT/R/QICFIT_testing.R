...
cardio <- read.csv("Z:/Data/Andrew/reference_data/qicfit_ready/GSE69360-fullwood_ID_CORR.csv",row.names = 1)
### Format
...
spearman.results <- spearman.calc(cardio, ref.df = ref.df)
...
plot.spearman(spearman.results[1:10], title="GSE69360-fullwood")
